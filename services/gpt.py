...
{
    "answer": число или null,    // Число (1-4) ТОЛЬКО если в вопросе есть пронумерованные варианты ответов, иначе ВСЕГДА null
...
2. Поле answer: число от 1 до 4 ТОЛЬКО при наличии пронумерованных вариантов, иначе СТРОГО null
